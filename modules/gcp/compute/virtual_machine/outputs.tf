output "id" {
  value = local.os_type == "linux" ? try(google_compute_instance.vm["linux"].id, null) : try(google_compute_instance.vm["windows"].id, null)
}


output "self_link" {
  value = local.os_type == "linux" ? try(google_compute_instance.vm["linux"].self_link, null) : try(google_compute_instance.vm["windows"].self_link, null)
}
